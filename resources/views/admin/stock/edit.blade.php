...
@section('titulo', 'Editar Movimiento de Stock')

@section('contenido')
    <div class="container mx-auto px-4 py-8 min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50">
        <div class="flex justify-between items-center mb-8">
            <h1 class="text-3xl font-bold text-gray-800 tracking-tight">Editar Movimiento de Stock</h1>
        ...
        <div class="bg-white rounded-xl shadow-xl p-8 transition-all duration-300 hover:shadow-2xl">
            ...
            <form action="{{ route('admin.stock.update', $stock) }}" method="POST" class="space-y-8">
                @csrf
                @method('PATCH')
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="form-group">
                            ...
                            <select name="tipo_movimiento" id="tipo_movimiento"
                                ...
                                <option value="entrada" {{ $stock->tipo_movimiento == 'entrada' ? 'selected' : '' }}>Entrada</option>
                                <option value="salida" {{ $stock->tipo_movimiento == 'salida' ? 'selected' : '' }}>Salida</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        <div class="form-group">
                            ...
                            <input type="number" name="cantidad" id="cantidad"
                                ...
                                value="{{ $stock->cantidad }}" required min="1">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="datetime-local" name="fecha_movimiento" id="fecha_movimiento"
                                ...
                                value="{{ $stock->fecha_movimiento->format('Y-m-d\\TH:i') }}" required>
                        </div>
                    </div>
