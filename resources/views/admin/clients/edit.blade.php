    ...
    <div class="bg-orange-100 p-6 rounded-xl shadow-md">
        <div class="flex justify-between items-center mb-8">
            <div class="flex items-center space-x-4">
                <i class="fas fa-user-edit text-4xl text-orange-500"></i>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="tel" name="telefono" id="telefono" required
                            class="w-full border-gray-300 rounded-md shadow-sm focus:ring-orange-500 focus:border-orange-500"
                            value="{{ old('telefono', $client->teléfono) }}">
                    </div>
                    ...
                    <div class="space-y-2 md:col-span-2">
                        ...
                        <textarea name="direccion" id="direccion" rows="3"
                            class="w-full border-gray-300 rounded-md shadow-sm focus:ring-orange-500 focus:border-orange-500">{{ old('direccion', $client->direccion) }}</textarea>
                    </div>
                </div>
